import {LANGUAGE_TRANSLATIONS, LANGUAGES} from "../../i18n.js";
...
<div class="relative inline-flex items-center">
  <svg
    ...
    viewBox="0 0 512 512"
    fill="currentColor"
    class="absolute left-2 pointer-events-none w-5 h-5 text-gray-600 dark:text-gray-300 z-10"
  >
  ...
  <select
    ...
    @change="handleChange"
    class="h-10 bg-white border rounded pr-6 py-1 dark:bg-gray-800 dark:border-gray-600 cursor-pointer"
    :style='{
      width: "40px",
      paddingLeft: "8px",
      color: "transparent",
  ...
  >
    <option
      ...
      :key="language"
      :value="language"
      class="text-black dark:text-white dark:bg-gray-800"
      :style="{ textIndent: '0', color: 'inherit' }"
    >
      {{ LANGUAGE_TRANSLATIONS[language] || language }}
    </option>
  </select>
</div>  
`,
