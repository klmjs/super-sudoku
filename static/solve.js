import {sortBy, SQUARE_TABLE, SUDOKU_NUMBERS, squareIndex} from "./utility.js";
 ...
 */
export function _solveGridAC3(stack, iterations) {
  while (stack.length > 0) {
    ...
    const possibleRowAndCells = grid.reduce((current, row, index) => {
